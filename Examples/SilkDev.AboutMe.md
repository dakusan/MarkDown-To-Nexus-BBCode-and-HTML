...
body #___markdown-content___ blockquote { margin:10px 0 30px !important; padding:25px !important; border-left:.25em solid #da8e35; line-height:1.5; font-style:italic; color:#e1e1e1; background-color:#383838; }
...
* One-click extraction of all textures
    1. Press **F1** → **Extract all textures**
    2. Dumps to _**<font color=green>PLUGIN\_PATH</font>**/Textures/**<font color=green>NAME</font>**-**<font color=green>MD5</font>**.png_ (no duplicates)
...
* Tons of classes and functions to make development easier. Most useful include:
	* Configs
		* Configuration translations and properly sorted by order
		...
		+ <details><summary>Spoiler</summary>Don’t spoil me!</details>
	* Input helpers (mouse visibility, joystick vector, input repeat delays, block specific input actions, etc.)

<font size=2>Full source + detailed class docs in the GitHub repo (coming soon)</font>
...
<p align=right><b><font color=red>--snip--</font></b></p>
